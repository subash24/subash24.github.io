      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input  name="email" type="email" class="form-control" id="lemail" placeholder="Email" name="email" required>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="password" class="form-control" id="lpassword" placeholder="Password" name= "password" required>
